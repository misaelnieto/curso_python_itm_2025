...
- M.I. UABBC - Instituto de Ingeniería (2018)
...
timeline
    ...
    1980's : Bases del lenguaje: Lenguaje ABC: Guido Van Rossum - 1989
    1991 : Python 0.9
    1994 : Python 1.0
         : Primer taller de Python con 20 Participantes
    2000 : Python 2.0
    2008 : Python 3.0
    2010 : Python 2.7 (Ultima version de Python 2.x)
    2020 : Python 3.9
         : Fin de vida de Python 2.7
    2024 : Python 3.14
```

---

![alt text](imagenes/python_timeline.svg)
